...
<head>
  ...
  <title>{title}</title>
  <link rel="icon" type="image/jpeg" href="assets/media/rocky-home-icon.jpeg">
...
.sidebar-toggle { flex: 0 0 auto; width: 40px; height: 40px; border-radius: 12px; border: 1px solid rgba(125,211,252,.18); background: rgba(5, 8, 22, 0.84); color: var(--text); cursor: pointer; transition: transform .15s ease, border-color .15s ease, background .15s ease, opacity .15s ease; display: inline-flex; align-items: center; justify-content: center; padding: 0; }
.sidebar-toggle:hover { transform: translateY(-1px); border-color: rgba(125,211,252,.42); background: rgba(125,211,252,.10); }
.sidebar-toggle-icon { width: 18px; height: 18px; display: block; }
.sidebar-collapse-toggle { position: absolute; top: 50%; right: -10px; transform: translateY(-50%); z-index: 3; width: 22px; height: 62px; border-radius: 0 14px 14px 0; border-left: 0; background: linear-gradient(180deg, rgba(8,12,24,.98), rgba(10,16,34,.96)); box-shadow: -5px 0 16px rgba(0,0,0,.24); }
...
body.sidebar-collapsed .sidebar-expand-toggle { display: inline-flex; position: static; transform: none; width: 36px; height: 36px; border-radius: 10px; box-shadow: none; }
